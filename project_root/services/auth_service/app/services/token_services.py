from app.core.jwt_core import create_access_token, decode_token, generate_refresh_token, hash_refresh_token
...
class AuthService:
    ...
    async def login_user(self, db: AsyncSession, email: str, password: str):
        ...
        try:
            ...
            await self.t_repo.create_token(db, user.id, token_hash, expires_at=now + timedelta(days=7))
